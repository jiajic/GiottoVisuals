...
- `vis_spatial.R` - plotting with aggregated information
- `vis_spatial_in_situ.R` - plotting with raw points and polygons information

`gg_` - ggplot2 related    
- `gg_info_layers.R` - modular internals for plotting the different layers of information    
- `gg_annotation_raster.R` - image pipeline
